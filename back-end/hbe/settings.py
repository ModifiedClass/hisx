"""
Django settings for hbe project.
...
SECRET_KEY = '7!q#$ss1jq_vco(f@*^#ouo2r9bi8kn1942-u-63j^)^a708ze'
...
WSGI_APPLICATION = 'hbe.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'hisx.sqlite3'),
    }
}
